...
\item Abdeckung des gesamten Nachthimmels %(nördlichen und südlichen) Himmels
\end{itemize}
...
\caption{Der Prototyp des MST in Berlin. Die Tscherenkow-Kamera wurde durch einen Dummy ersetzt und in der Mitte des Reflektors befinden sich drei CCD-Kameras. (Bildquelle: Ullrich Schwanke)}%, die in Abbildung \ref{img:cameras} besser zu sehen sind.}
\label{img:mst}
\end{figure}
