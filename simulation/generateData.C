...
void generateData(){
  TNtuple *drive = new TNtuple("drive", "drive","el:az",32000);
  TNtuple *astro0 = new TNtuple("astro0", "drive0","el0:az0",32000);
  TNtuple *astro1 = new TNtuple("astro1", "drive1","el1:az1:alpha_rand1",32000);
  TNtuple *astro2 = new TNtuple("astro2", "drive2","el2:az2:alpha_rand2",32000);
  ...
  for (int i=1; i<=N;i++){
    ...
    drive->TNtuple::Fill(el[i],az[i]);
    astro0->TNtuple::Fill(el0[i],az0[i]);
    astro1->TNtuple::Fill(el1[i],az1[i],alpha_rand1[i]);
    astro2->TNtuple::Fill(el2[i],az2[i],alpha_rand2[i]);
  }
